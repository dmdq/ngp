...
<form:form id="searchForm" commandName="searchDevice" modelAttribute="searchDevice"
	action="${pageContext.request.contextPath}/web/device" method="post">
...
<c:if test="${!empty devices}">
<display:table name="devices" defaultsort="1"
	requestURI="/web/device" class="datagrid1"
	style="width:80%;" defaultorder="descending" id="device">
	<display:column property="id" title="ID" />
	<display:column property="mac" title="Mac" />
	<display:column property="brand" title="Brand" />
	<display:column property="model" title="Model" />
	<display:column property="os" title="OS" />
	<display:column property="udid" title="UDID" />
	<display:column property="openUdid" title="OpenUDID" />
	<display:column property="idfa" title="IDFA" />
</display:table></c:if>
<div style="width:1000px;height:20px;">&nbsp;</div>
