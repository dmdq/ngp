...
<div style="width: 500px; height: 400px; margin: 0px auto;">
	...
	<div style="width: 500px; height: 30px;">
		<form:form id="form1" commandName="resFile" modelAttribute="resFile"
			action="${pageContext.request.contextPath}/web/resFile/add" enctype="multipart/form-data" method="post">
			<!-- 内容区域 -->
