...
<form:form id="searchForm" commandName="searchFileStorage" modelAttribute="searchFileStorage"
	action="${pageContext.request.contextPath}/web/report/coc/remain" method="post">
...
<form id="searchAndPageForm" action="${pageContext.request.contextPath}/web/report/coc/remain" method="post">
