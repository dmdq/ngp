...
<script type="text/javascript">
	...
	$(function() {
		...
		var url = '<c:url value="/web/report/coc/queryUserCountByRate"/>';
    	$.ajax({ 
			type: "POST", 
			dataType: "json",
	...
	var myChart = new FusionCharts("${pageContext.request.contextPath}/charts/Column3D.swf", "myChartId", "700", "500", "0", "1");
