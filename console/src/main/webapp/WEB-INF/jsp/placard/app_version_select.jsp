...
<script type="text/javascript">
    ...
    function selectAppVersion(appId, versionName) {
    	window.parent.document.getElementById("appVersion").value = versionName;
	}
...
<form:form id="searchForm" commandName="searchAppVersion" modelAttribute="searchAppVersion"
	action="${pageContext.request.contextPath}/web/placardTarget/selectAppVersions" method="post">
...
<table  class="datagrid1" style="width:80%;">
  ...
  <c:forEach items="${appVersions }" var="appVersion">
   <tr>
      <td>
         <input type="radio" name="radio" onclick="selectAppVersion('${appVersion.appId }', '${appVersion.version }');"/>
      </td>
      <td>${appVersion.id }</td>
