...
<body>
	<h2>Update Placard</h2>
	
	<!-- 内容区域 -->
	<div id="content" align="center">
<form:form id="form1" commandName="placard" modelAttribute="placard"
	action="${pageContext.request.contextPath}/web/placard/update" method="post">
	...
	<table class="entity-form" align="center">
		<tr>
			<th>公告编号&nbsp;<font color="red">*</font>&nbsp;</th>
			<td colspan="2">
				<c:out value="${placard.id}"/>
				<input type="hidden" name="id" value="${placard.id}"/>
				<input type="hidden" name="createBy" value="${placard.createBy}"/>
				<input type="hidden" name="createTime" value="${placard.createTime}"/>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td colspan="2">
				<input name="beginTime" id="beginTime" class="required" readonly="readonly" size="50" maxlength="50" value="<fmt:formatDate value="${placard.startTime}" pattern="yyyy-MM-dd HH:mm:ss" />"/>
			</td>
		</tr>
		<tr>
			<th>结束时间&nbsp;<font color="red">*</font>&nbsp;</th>
			<td>
				<input name="overTime" id="overTime" class="required" readonly="readonly" size="50" maxlength="50" value="<fmt:formatDate value="${placard.endTime}" pattern="yyyy-MM-dd HH:mm:ss" />"/>
			</td>
		</tr>
	</table>
</form:form>
