...
<body>
	<h2>Update SlotsProduct</h2>
	
	<!-- 内容区域 -->
	<div id="content" align="center">
<form:form id="form1" commandName="searchSlotsProduct" modelAttribute="searchSlotsProduct" 
	action="${pageContext.request.contextPath}/web/product/update" method="post">
	...
	<table class="entity-form" align="center">
		<tr>
			...
			<td colspan="2">
				<form:input path="productId" cssClass="required" size="50" maxlength="50"/>
			</td>
		</tr>
		<tr>
			<th>价格&nbsp;<font color="red">*</font>&nbsp;</th>
			<td colspan="2">
				<form:input path="amount" cssClass="required" size="50" maxlength="50"/>
			</td>
		</tr>
		<tr>
			<th>描述&nbsp;&nbsp;</th>
