...
<body>
	<h2>Create SlotsProduct</h2>
	
	<!-- 内容区域 -->
	<div id="content" align="center">
<form:form id="form1" commandName="searchSlotsProduct" modelAttribute="searchSlotsProduct" 
	action="${pageContext.request.contextPath}/web/product/add" method="post">
	...
	<table class="entity-form" align="center">
		...
		<tr>
			...
			<td colspan="2">
				<form:input path="amount" size="50" cssClass="required" maxlength="50"/>
			</td>
		</tr>
		<tr>
			<th>描述&nbsp;&nbsp;</th>
