...
<body>
	<h2>Create AppZone</h2>
	
	<!-- 内容区域 -->
	<div id="content" align="center">
<form:form id="form1" commandName="searchAppZone" modelAttribute="searchAppZone"
	action="${pageContext.request.contextPath}/web/appZone/add" enctype="multipart/form-data" method="post">
	<table class="entity-form" align="center">
		<tr>
			<th>是否BaseId&nbsp;<font color="red">*</font>&nbsp</th>
			<td colspan="2">
				<select name="isBaid" id="isBaid" class="required">
		...
		<tr>
			...
			<td colspan="2">
				...
				<input type="text" name="appName" id="appName" readonly="readonly" class="required" size="50" maxlength="50" />
		...
		<tr>
			...
			<td>
				<select name="zoneIds" id="zoneIds" class="required" multiple="multiple" style="width:80%" size="5"></select>
			</td>
			<td>
