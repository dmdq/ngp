...
<form:form id="form1" commandName="promo" modelAttribute="promo" 
	action="${pageContext.request.contextPath}/web/promo/update" enctype="multipart/form-data" method="post">
	...
	<table class="entity-form" align="center">
		...
		<tr>
			<th>Promo Icon&nbsp;&nbsp;</th>
			<td colspan="2">
				<input type="file" name="icons" class="image" id="icon" size="50" />
			</td>
		</tr>
	</table>
</form:form>
