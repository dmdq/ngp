...
<body>
	<h2>Create AppVersion</h2>
	
	<!-- 内容区域 -->
	<div id="content" align="center">
<form:form id="form1" commandName="searchAppVersion" modelAttribute="searchAppVersion"
	action="${pageContext.request.contextPath}/web/appVersion/add" enctype="multipart/form-data" method="post">
	...
	<table class="entity-form" align="center">
		<tr>
			...
			<td colspan="2">
				<input type="text" name="appId" id="appId" readonly="readonly" class="required" size="50" maxlength="50" />
				<input type="button" id="addAppBtn" onclick="selectView('<c:url value='/web/resUpdate/selectApp'/>');" value="选择">
			</td>
		</tr>
		<tr>
			<th>Version&nbsp;&nbsp;</th>
