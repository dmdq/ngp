...
<form:form id="form1" commandName="app" modelAttribute="app"
	action="${pageContext.request.contextPath}/web/app/add" enctype="multipart/form-data" method="post">
	...
	<table class="entity-form" align="center">
		...
		<tr>
			...
			<td colspan="2">
				<form:input path="id" size="50" maxlength="50"/>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<th>BaseId&nbsp;&nbsp;</th>
			<td colspan="2">
				<input type="text" name="baseId" id="baseId" readonly="readonly" size="50" maxlength="50" />
		...
		<tr>
			<th>Version&nbsp;&nbsp;</th>
			<td colspan="2">
				<input type="text" name="appVersion" id="appVersion" size="50" maxlength="50" />
			</td>
		</tr>
	</table>
</form:form>
