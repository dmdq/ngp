...
<script type="text/javascript">
    ...
    function selectEngines(baseId, baseName) {
		window.parent.document.getElementById("baseId").value = baseId;
	}
...
<form:form id="searchForm" commandName="searchApp" modelAttribute="searchApp"
	action="${pageContext.request.contextPath}/web/app/selectBaseId" method="post">
