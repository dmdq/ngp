...
<body>
    <!-- item12_tire5_amazingcandymatchinggame0708 -->
<form action="${pageContext.request.contextPath}/misc/paypal/sec.st" method="post" target="_top">
	<table>
                <tr>
                        <td width="300" align="right">
                                <img alt="Wheel Candy X3" src="${pageContext.request.contextPath}/images/item_12.png">
                        </td>
                        <td>
...
<input type="hidden" name="NAME" value="Wheel Candy X3" />
                ...
                <tr>
                        <td colspan="2" align="left"><span style="font-size: 60px; color:#333333; float:left;">Turn 3 candies to rainbow candies.</span></td>
                </tr>
                <tr>
