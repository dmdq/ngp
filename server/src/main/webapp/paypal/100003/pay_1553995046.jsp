...
<title>Refill Lives</title>
</head>
<body>
    <!-- item13_tire1_amazingcandymatchinggame0708 -->
<form action="${pageContext.request.contextPath}/misc/paypal/sec.st" method="post" target="_top">
	<table>
                <tr>
                        <td width="300" align="right">
                                <img alt="Refill Lives" src="${pageContext.request.contextPath}/images/item_mover.png">
                        </td>
                        <td>
                                <span style="font-size: 40px; color:#9900FF;">&nbsp;Refill Lives</span><br/><br/>
                                <span style="font-size: 80px; color:#FF00FF;">&nbsp;$0.99</span><br/><br/>
<input type="hidden" name="NAME" value="Refill Lives" />
